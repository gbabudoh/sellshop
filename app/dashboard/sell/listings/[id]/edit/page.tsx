      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            condition: data.condition || "USED_LIKE_NEW",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 relative py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <motion.div variants={itemVariants} className="mb-8 text-center sm:text-left">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Edit Listing</h1>
          <p className="text-gray-500 mt-2 font-medium">Update the details for your product.</p>
        </motion.div>
        ...
        {isSuccess ? (
          ...
          >
            ...
            <h2 className="text-3xl font-extrabold text-gray-900 mb-4">Listing Updated!</h2>
            <p className="text-gray-600 mb-8 font-medium">Your product details have been successfully saved.</p>
